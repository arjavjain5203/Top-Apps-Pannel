...
class topAppsProPanelBox extends St.BoxLayout {
    _init(monitor) {
        super._init({
            name: 'panelBox',
...
class topAppsProPanel extends St.Widget {
    _init(monitor) {
        super._init({
            name: 'panel',
            style_class: 'panel topAppsPro-panel',
            reactive: true,
        });
    ...
    _addToPanelBox(role, indicator, position, box) {
        ...
        if (parent)
            Utils.removeChildFromParent(parent, container);
    ...
    _removePanelMenu(propName) {
        if (this.statusArea[propName]) {
            ...
            if (parent)
                Utils.removeChildFromParent(parent, this.statusArea[propName].container);
