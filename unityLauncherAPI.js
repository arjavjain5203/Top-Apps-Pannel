...
export const LauncherEntryRemoteModel = class topAppsProLauncherEntryRemoteModel {
    constructor() {
...
const LauncherEntry = class topAppsProLauncherEntry {
    constructor() {
...
const PropertySourceStack = class topAppsProPropertySourceStack {
