...
export default class TopAppsPro extends Extension {
    ...
    enable() {
        ...
        this.settings.connectObject('changed::panel-location', () => {
            void Theming.updateStylesheet().then(() => {
        ...
        this.settings.connectObject('changed::main-panel-height', () => {
            this._writeTimeoutId = Utils.safeSourceRemove(this._writeTimeoutId);

            this._writeTimeoutId = Utils.timeoutAddOnce(GLib.PRIORITY_DEFAULT, 300, () => {
                this._writeTimeoutId = 0;
                if (this._isDestroyed)
                    return;
        ...
        global.connectObject('shutdown', () => void Theming.deleteStylesheet(), this);
